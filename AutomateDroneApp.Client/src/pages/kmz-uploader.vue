<template>
  <div class="mt-8 mb-20 mx-auto max-w-fit">
      ...
      <template #geometryFile="{ geometryFile }">
        ...
        <div class="flex items-center justify-center space-x-4">
          ...
          <RouterLink
              ...
              :to="{name:'/map-view/[id]',params:{ id: fixJson(geometryFile).id}}"
          >
            View on Map
          </RouterLink>
        </div>
    ...
    <AutoEditForm v-show="false" type="CreateS3FileItem"/>
...
const fixJson = function (json: any) {
  try {
    const t = json.id;
    return json;
  } catch (e) {
