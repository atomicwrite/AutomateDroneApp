...
const project = ref('AutomateDroneApp')
const projectZip = computed(() => (project.value || 'AutomateDroneApp') + '.zip')

/** @param {string} template */
const zipUrl = (template:string) =>
    `https://account.servicestack.net/archive/${template}?Name=${project.value || 'AutomateDroneApp'}`
